...
9.  **FAIR PLATFORM DISTRIBUTION**: Your output MUST draw quotes from a DIVERSE MIX of platforms proportional to their representation in the evidence. Do NOT over-index on any single source. Specifically: if Amazon reviews are 40% of data, ~40% of your quotes should cite Amazon. If YouTube/Reddit/Quora/Twitter appear in the evidence, they MUST be represented in your quotes. Instagram and Facebook Group quotes from the curated bank should supplement — NOT dominate — the output. A good section should cite at LEAST 4 different Source: platforms. Prioritize ingested data (non-CURATED IDs) over curated items.
