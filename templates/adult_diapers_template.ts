...
export const ADULT_DIAPERS_TEMPLATE: TemplatePack = {
    ...
    "brand_landscape": `
        ...
        **brands** (Array, MINIMUM 6 brands):
        ...
        VERBATIM REQUIREMENTS: Min 4 per brand. Mix positive AND negative. Sound like real Indian consumers.

        STRENGTH/WEAKNESS: Min 2 each per brand. Be specific — "Good absorption" is too vague. "Handles 8-hour overnight without side-leakage" is specific.
