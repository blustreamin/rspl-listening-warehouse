...
export const TEMPLATE_REGISTRY: Record<ProjectId, TemplatePack> = {
  ...
  "disposable-period-panties": {
    ...
    sections: [
      ...
      { sectionId: "8", title: "Awareness & Channels", uiSpec: "funnel", schema: { type: "object", required: ["discovery_sources"] } },
    ...
    promptPack: {
      ...
      sectionPrompts: {
        ...
        Output Object: {
           "brand_performance": Array<{brand, key_strengths: string[], key_weaknesses: string[], attribute_verdict: string, evidence_ids: []}>
        }
        
        STRATEGIC DIRECTIVE:
        Competitive Landscape Audit (India).
        MANDATORY BRANDS: Whisper, Nua, Plush, Evereve, Carmesi, Sirona, Pee Safe, Azah, Rael.
        For each:
        - Market Structure Position (Leader, Challenger, Niche).
        ...
        STRATEGIC DIRECTIVE:
        Funnel Analysis: Discovery -> Validation -> Conversion.
        - Dominant discovery: Influencers (Insta/YouTube) vs Search vs Peer.
        - Validation: Reviews on Amazon/Nykaa vs Chemist trust.
        ...
        Output Object: {
           ...
           "non_users": { "barriers_to_try": Array<{title, bullets[]}> },
           ${SEGMENTATION_SCHEMA_DESCRIPTION}
        }
        
        STRATEGIC DIRECTIVE:
        Comprehensive Category Audit.
        1. Core Strategic Role (e.g. "The Sleep Savior").
        2. Attribute Performance (Comfort, Leakage, Absorption, Dryness, Softness, Odour, Thickness, Fit).
  ...
  "reusable-period-panties": {
    templateId: "femcare_reusable_v3_0",
    ...
    sections: [
      ...
      { sectionId: "5", title: "Deep Dive: Reusable Period Panties", uiSpec: "text-list", schema: {} },
      { sectionId: "6", title: "Deep Dive: Disposable Period Panties", uiSpec: "text-list", schema: {} },
    ...
    promptPack: {
      systemPrompt: ANALYST_GRADE_SYSTEM_PROMPT,
      sectionPrompts: {
        "1": "Generate 'menstruation_context' with 3-Layer Context Analysis: Macro Trend (Sustainability in Urban India), Behavioral Reality (Washing in joint families/hostels), Emotional Impact (Eco-guilt vs Convenience). Min 6 cards.",
        "gap_analysis": GAP_ANALYSIS_PROMPT,
        "2": "Generate 'behavioural_landscape'. Triggers: Eco-conscious, Rash-prevention. Barriers: Washing logistics (drying in open), drying taboo, humidity/drying time concerns. Switching: Pads -> Reusables.",
        "3": "Generate 'product_ecosystem'. Map Reusables vs Disposables vs Cups. Focus on complementary usage in India.",
        "4": "Generate 'awareness_channels'. Discovery funnel: Sustainability Influencers -> Validation -> Purchase. Metro vs Tier 2.",
        "5": "Generate 'deep_dive_reusable'. Core Role: 'Sustainable Daily Wear'. Attribute Audit: Absorbency, Drying Time (Monsoon factor), Fit, Longevity. " + SEGMENTATION_SCHEMA_DESCRIPTION,
        "6": "Generate 'deep_dive_disposable'. Focus on usage as 'Backup' or 'Heavy Day' alternative.",
        "7": "Generate 'brand_landscape'. Brands: GoSats, HealthFab, Soch, Adira, Uniqlo. Market Structure & Vulnerabilities.",
        "8": "Generate 'visuals'. Strategic themes: 'Eco-Anxiety', 'Wash-Routine', 'Investment Cost', 'Rash Freedom'."
      }
    },
    validators: {},
    fallbacks: {
        "1": { cards: [{ boldTitle: "Eco-Shift", bullets: ["SEED: Shift away from single-use plastics."], confidence: "MED", evidence_ids: [] }] },
        "gap_analysis": FALLBACK_GAP_ANALYSIS,
